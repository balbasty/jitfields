...
#include "utils.h"
#include "posdef_utils.h"
#include "posdef_cholesky.h"
...
struct common
{
    ...
    void solve_(vptr_t v, hptr_t h, wptr_t w = nullptr, bptr_t b = nullptr,
                reduce_t unused = static_cast<reduce_t>(0))
    {
        Child::solve_impl_(v, h, w, b, unused);  // v <- (H + diag(w)) \ v
    }

    template <typename xptr_t, typename vptr_t, typename hptr_t,
              typename wptr_t = const void *, typename bptr_t = const void *,
              typename reduce_t = typename internal::return_type<
                                  xptr_t, vptr_t, hptr_t, wptr_t, bptr_t>::value>
    static inline __device__
    void solve(xptr_t x, vptr_t v, hptr_t h, wptr_t w = nullptr, bptr_t b = nullptr,
               reduce_t unused = static_cast<reduce_t>(0))
    {
        copy_(x, v);                             // x <- v
    ...
    template <typename xptr_t, typename vptr_t, typename hptr_t,
              ...
              typename reduce_t = typename internal::return_type<
                                  xptr_t, vptr_t, hptr_t, wptr_t, bptr_t>::value>
    static inline __device__
    void relax_(xptr_t x, hptr_t h, vptr_t v,
    ...
    template <typename vptr_t, typename hptr_t, typename wptr_t = const void *>
    static inline __device__
    void solve_(vptr_t v, hptr_t h, wptr_t w, double unused)
    {
    ...
    static inline __device__
    void solve_(vptr_t v, hptr_t h, wptr_t w, float unused)
    {
        const void * b = nullptr;
        return this_type::solve_(v, h, w, b, unused);
    }
    ...
    template <typename vptr_t, typename hptr_t,
              typename wptr_t = const void *>
    static inline __device__
    void solve_(vptr_t v, hptr_t h, wptr_t w, half unused)
    {
        const void * b = nullptr;
        return this_type::solve_(v, h, w, b, unused);
    }
    ...
    static inline __device__
    void solve(xptr_t x, vptr_t v, hptr_t h, wptr_t w, double unused)
    {
        const void * b = nullptr;
    ...
    template <typename xptr_t, typename vptr_t,
              typename hptr_t, typename wptr_t = const void *>
    static inline __device__
    void solve(xptr_t x, vptr_t v, hptr_t h, wptr_t w, float unused)
    {
        const void * b = nullptr;
        return this_type::solve(x, v, h, w, b, unused);
    }
    ...
    template <typename xptr_t, typename vptr_t,
              typename hptr_t, typename wptr_t = const void *>
    static inline __device__
    void solve_(xptr_t x, vptr_t v, hptr_t h, wptr_t w, half unused)
    {
        const void * b = nullptr;
        return this_type::solve(x, v, h, w, b, unused);
    }
    ...
    template <typename xptr_t, typename vptr_t,
              typename hptr_t, typename wptr_t = const void *>
    static inline __device__
    void relax_(xptr_t x, hptr_t h, vptr_t v, wptr_t w, float unused)
    {
        const void * b = nullptr;
    ...
    template <typename xptr_t, typename vptr_t,
              typename hptr_t, typename wptr_t = const void *>
    static inline __device__
    void relax_(xptr_t x, hptr_t h, vptr_t v, wptr_t w, double unused)
    {
        const void * b = nullptr;
        return this_type::relax_(x, h, v, w, b, unused);
    }
...
struct common<Child, offset_t, 0>
{
    ...
    template <typename vptr_t, typename hptr_t,
              ...
              typename reduce_t = typename internal::return_type<
                                  vptr_t, hptr_t, wptr_t, bptr_t>::value>
    static inline __device__
    void solve_(offset_t C, vptr_t v, hptr_t h,
                wptr_t w = nullptr, bptr_t b = nullptr,
                reduce_t unused = static_cast<reduce_t>(0))
    {
    ...
    template <typename xptr_t, typename vptr_t, typename hptr_t,
              ...
              typename reduce_t = typename internal::return_type<
                                  xptr_t, vptr_t, hptr_t, wptr_t, bptr_t>::value>
    static inline __device__
    void solve(offset_t C, xptr_t x, vptr_t v, hptr_t h,
               wptr_t w = nullptr, bptr_t b = nullptr,
               reduce_t unused = static_cast<reduce_t>(0))
    {
        copy_(C, x, v);                             // x <- v
    ...
    template <typename xptr_t, typename vptr_t, typename hptr_t,
              ...
              typename reduce_t = typename internal::return_type<
                                  xptr_t, vptr_t, hptr_t, wptr_t, bptr_t>::value>
    static inline __device__
    void relax_(offset_t C, xptr_t x, hptr_t h, vptr_t v,
                wptr_t w = nullptr, bptr_t b = nullptr,
                reduce_t unused = static_cast<reduce_t>(0))
    {
    ...
    // Because of the use of templates, I have to wtie it down for each
...
#include "posdef_eye.inl"
#include "posdef_diag.inl"
#include "posdef_estatics.inl"
#include "posdef_sym.inl"
#include "posdef_full.inl"
