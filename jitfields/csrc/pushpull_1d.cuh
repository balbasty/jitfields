 ...
 */
#ifndef JF_PUSHPULL_LOOP1D_CU
#define JF_PUSHPULL_LOOP1D_CU
...
__global__ void pull1d(scalar_t * out, scalar_t * inp, scalar_t * grid, int ndim,
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void push1d(scalar_t * out, scalar_t * inp, scalar_t * grid, int ndim,
            const offset_t * size_grid,
            const offset_t * size_splinc,
            const offset_t * stride_out,
            const offset_t * stride_inp,
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void count1d(scalar_t * out, scalar_t * grid, int ndim,
             const offset_t * size_grid,
             const offset_t * size_splinc,
             const offset_t * stride_out,
             const offset_t * stride_grid)
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void grad1d(scalar_t * out, scalar_t * inp, scalar_t * grid, int ndim,
            const offset_t * size_grid,
            const offset_t * size_splinc,
            const offset_t * stride_out,
            const offset_t * stride_inp,
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void pull1d_backward(
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void push1d_backward(
    scalar_t * out, scalar_t * gout,
    scalar_t * inp, scalar_t * ginp,
    scalar_t * grid, int ndim,
    const offset_t * size_grid,
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void count1d_backward(
...
template <spline::type IX, bound::type BX, int extrapolate,
          typename reduce_t, typename scalar_t, typename offset_t>
__global__ void grad1d_backward(
    scalar_t * out, scalar_t * gout,
    scalar_t * inp, scalar_t * ginp,
    scalar_t * grid, int ndim,
    const offset_t * size_grid,
